...
Dump an example certificate (example-leaf.crt) to JSON output
  ...
  {"certificates":[{"serial":"14381893493177441266","not_before":"2016-06-10T22:14:12Z","not_after":"2023-04-15T22:14:12Z","signature_algorithm":"SHA256-RSA","is_self_signed":true,"subject":{"common_name":"example-small-key","country":["US"],"organization":["certigo"],"organizational_unit":["example"],"province":["CA"]},"issuer":{"common_name":"example-small-key","country":["US"],"organization":["certigo"],"organizational_unit":["example"],"province":["CA"]},"warnings":["[e_sub_cert_aia_does_not_contain_ocsp_url] ","[e_ext_san_missing] ","[e_sub_cert_eku_missing] ","[e_invalid_certificate_version] ","[e_sub_cert_aia_missing] ","[w_ext_subject_key_identifier_missing_sub_cert] ","[e_rsa_mod_less_than_2048_bits] ","[e_sub_cert_certificate_policies_missing] ","[e_subject_common_name_not_from_san] ","[e_sub_cert_cert_policy_empty] "],"pem":"-----BEGIN CERTIFICATE-----\\n-----END CERTIFICATE-----\n"}]}
